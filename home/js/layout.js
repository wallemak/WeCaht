(function() {
        ...
        y = function(a, b) {
            ...
            switch (b) {
                ...
                case "path":
                    ...
                    a = a.split("/");
                    a: if (b = a[a.length - 1], c = [], Array.prototype.indexOf) b = c.indexOf(b),
    ...
    var Q = function(a, b, c) {
            ...
            r.history && r.history.replaceState && (M.test(b) || M.test(c)) && (a = y(a, "path"), b = d(b, "?"), c = d(c, "#"), r.history.replaceState({},
                void 0, "" + a + b + c))
        },
        P = function(a) {
            var b = void 0 === b ? 3 : b;
    ...
    function U(a, b, c) {
        for (var d = {},
                 e = {},
                 f = I().decorators, g = 0; g < f.length; ++g) {
            var h = f[g]; (!c || h.forms) && H(h.domains, b) && (h.fragment ? n(e, h.callback()) : n(d, h.callback()))
        }
    ...
    var X = function(a) {
        ...
        }; l("google_tag_data.glBridge.auto",
        function(a, b, c, d) {
            var e = I();
            ...
            I().decorators.push(a)
        }); l("google_tag_data.glBridge.decorate",
        function(a, b, c) {
            c = !!c;
            a = O(a);
            if (b.tagName) {
        ...
        }); l("google_tag_data.glBridge.generate", O); l("google_tag_data.glBridge.get",
        function(a, b) {
            var c = R( !! b);
            b = I();
            b.data || (b.data = {
...
var oe = function() {
        ...
        g.onreadystatechange = function() {
            if (4 == g.readyState) {
                if (d) try {
                    ...
                    if (1 > ca.length) ge("xhr", "ver", "0"),
                        c();
                    else if ("1" != ca.charAt(0)) ge("xhr", "ver", String(ca.length)),
                        c();
    ...
    ge = function(a, b, c) {
        1 <= 100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j75", "sr=1"], b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc("https://www.google-analytics.com/u/d", a.join("&"), ua))
    };
var h = function(a) {
...
var ue = new ee,
    ...
    db = function() {};
var hb = T("apiVersion", "v"), ib = T("clientVersion", "_v");S("anonymizeIp", "aip");
...
var ub = S("eventCategory", "ec"), xb = S("eventAction", "ea"), yb = S("eventLabel", "el"), zb = S("eventValue", "ev"), Bb = S("socialNetwork", "sn"), Cb = S("socialAction", "sa"), Db = S("socialTarget", "st"), Eb = S("l1", "plt"), Fb = S("l2", "pdt"), Gb = S("l3", "dns"), Hb = S("l4", "rrt"), Ib = S("l5", "srt"), Jb = S("l6", "tcp"), Kb = S("l7", "dit"), Lb = S("l8", "clt"), Ve = S("l9", "_gst"), We = S("l10", "_gbt"), Xe = S("l11", "_cst"), Ye = S("l12", "_cbt"), Mb = S("timingCategory", "utc"), Nb = S("timingVar", "utv"), Ob = S("timingLabel", "utl"), Pb = S("timingValue", "utt");S("appName", "an");S("appVersion", "av", "");S("appId", "aid", "");S("appInstallerId", "aiid", "");S("exDescription", "exd");S("exFatal", "exf");
...
var Ze = T("_cd2l", void 0, !1), ld = S("usage", "_u"), Gd = S("_um");S("forceSSL", void 0, void 0,
    function() {
        return Ba
    },
    function(a, b, c) {
...
var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/,
    ...
    Jc = function(a, b) {
        ...
        if (a.get(Hd) && (c = be("_ga", !!a.get(cc)), g = be("_gl", !!a.get(cc)), d = De.get(a.get(cc)), e = d._ga, g && 0 < g.indexOf("_ga*") && !e && J(30), g = d.gclid, ca = d._gac, c || e || g || ca)) if (c && e && J(36), a.get(bc)) {
...
var we = N.N,
    xe = O[gb];xe && xe.r ? we() : z(we);z(function() {
